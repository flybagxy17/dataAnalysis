...
import kafka_producer.JsonUtil;
import kafka_producer.RandomUtil;
...
//import org.apache.kylin.common.util.kafka_producer.RandomUtil;
...
//        }
        ...
        props.put("bootstrap.servers", "tstkj002:6667");
        props.put("acks", "all");
        props.put("retries", 0);
        ...
        try (Producer<String, String> producer = new KafkaProducer<>(props)) {
            ...
            while (alive) {
                //add normal record
                record.put("order_time", (System.currentTimeMillis()));
                ...
                //send message
                ProducerRecord<String, String> data = new ProducerRecord<>("kylin_streaming_topic", System.currentTimeMillis() + "", mapper.writeValueAsString(record));
